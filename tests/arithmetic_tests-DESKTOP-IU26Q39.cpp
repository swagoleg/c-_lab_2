...
TEST(Addition, NegativeAndPositive) {
    int2025_t c = FromInt(-10);
    int2025_t d = FromInt(20);
    int2025_t expected = FromInt(10);
    int2025_t result = c + d;
    EXPECT_TRUE(result == expected);
}

TEST(Addition, BothNegative) {
    int2025_t e = FromInt(-10);
    int2025_t f = FromInt(-20);
    int2025_t expected = FromInt(-30);
...
TEST(Subtraction, ZeroMinus) {
    ...
    int2025_t zero = FromInt(0);
    int2025_t result = zero - a;
    int2025_t expected = FromInt(-42);
    EXPECT_TRUE(result == expected);
}


TEST(Multiplication, PositiveNumbers) {
    int2025_t a = FromInt(6);
    int2025_t b = FromInt(7);
    int2025_t expected = FromInt(42);
    int2025_t result = a * b;
    EXPECT_TRUE(result == expected);
}
...
TEST(Multiplication, NegativeAndPositive) {
    int2025_t c = FromInt(-6);
    int2025_t d = FromInt(7);
    int2025_t expected = FromInt(-42);
    int2025_t result = c * d;
    EXPECT_TRUE(result == expected);
}
...
TEST(Multiplication, BothNegative) {
    int2025_t e = FromInt(-6);
    int2025_t f = FromInt(-7);
    int2025_t expected = FromInt(42);
    int2025_t result = e * f;
    EXPECT_TRUE(result == expected);
}
...
TEST(Division, PositiveNumbers) {
    int2025_t a = FromInt(42);
    int2025_t b = FromInt(7);
    int2025_t expected = FromInt(6);
    int2025_t result = a / b;
    EXPECT_TRUE(result == expected);
}

TEST(Division, NegativeAndPositive) {
    int2025_t c = FromInt(-42);
    int2025_t d = FromInt(7);
    int2025_t expected = FromInt(-6);
    int2025_t result = c / d;
    EXPECT_TRUE(result == expected);
...
TEST(LargeNumbers, Addition) {
    int2025_t a = FromString("12345678901234567890");
    int2025_t b = FromString("98765432109876543210");
    int2025_t sum = a + b;
    int2025_t expected_sum = FromString("111111111011111111100");
    EXPECT_TRUE(sum == expected_sum);
}

TEST(LargeNumbers, Multiplication) {
    int2025_t product = FromString("123") * FromString("456");
    int2025_t expected_product = FromString("56088");
...
TEST_P(ArithmeticOperationsTestSuite, Addition) {
    ...
    int2025_t a = FromString(a_str.c_str());
    int2025_t b = FromString(b_str.c_str());
    int2025_t expected = FromString(expected_str.c_str());
